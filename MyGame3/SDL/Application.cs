...
{
	private static Sdl SDL => SDLWindow.SDL;
	...
	static Application()
	{
		InternalWindows = new Dictionary<IntPtr, WeakReference<SDLWindow>>(10);
	}
	...
	public static void RegisterWindow(SDLWindow c)
	{
		lock (InternalWindows)
		{
			InternalWindows.Add(c.SdlHandle, new WeakReference<SDLWindow>(c));
		}
	}
	...
	public static void UnregisterWindow(SDLWindow c)
	{
		lock (InternalWindows)
		{
	...
	/// </summary>
	public static SDLWindow WindowWithFocus { get; private set; }
	...
	/// </summary>
	public static List<SDLWindow> Windows
	{
		get
		{
			lock (InternalWindows)
			{
				var res = new List<SDLWindow>(InternalWindows.Count);
	...
	/// <returns></returns>
	private static SDLWindow WindowFromSdlHandle(Silk.NET.SDL.Window* w)
	{
		lock (InternalWindows)
		{
			WeakReference<SDLWindow> weakRef;
	...
	/// </summary>
	private static readonly Dictionary<IntPtr, WeakReference<SDLWindow>> InternalWindows;
